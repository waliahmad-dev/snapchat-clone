// Zodiac sign lookup by month (1-12) and day-of-month. Boundaries follow the
// standard Western tropical zodiac.
...
// Renders a yyyy-mm-dd date string as "15 Sep". Returns null for malformed
